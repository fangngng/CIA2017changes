...
--city lev
if exists (select * from dbo.sysobjects where id = object_id(N'IMS_HYP') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table IMS_HYP
go
...
where left(Therapeutic_Code,3) in ('C02','C03','C07','C08','C09')
...
update IMS_HYP set [TC I DESC]=b.Therapeutic_Name
from IMS_HYP a
inner join Dim_Therapeutic_Class b
on a.[TC I SHORT DESC] = b.Therapeutic_Code

update IMS_HYP set [TC II DESC]=b.Therapeutic_Name
from IMS_HYP a
inner join Dim_Therapeutic_Class b
on a.[TC II SHORT DESC] = b.Therapeutic_Code

update IMS_HYP set [TC III DESC]=b.Therapeutic_Name
from IMS_HYP a
inner join Dim_Therapeutic_Class b
on a.[TC III SHORT DESC] = b.Therapeutic_Code

update IMS_HYP set [TC IV DESC]=b.Therapeutic_Name
from IMS_HYP a
inner join Dim_Therapeutic_Class b
