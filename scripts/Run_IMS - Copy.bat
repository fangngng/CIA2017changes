...
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\2_MID_HKAPI.sql" 1>"IMS\log\2_MID_HKAPI.log" 2>"IMS\log\error_2_MID_HKAPI.log"
REM Pro
...
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\3_Output_HKAPI.sql" 1>"IMS\log\3_Output_HKAPI.log" 2>"IMS\log\error_3_Output_HKAPI.log"
