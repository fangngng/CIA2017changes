osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaMRBI -i "CPA\0_1_Import.sql" 1>"CPA\log\0_1_Import.log" 2>"CPA\log\error_0_1_Import.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaMRBI -i "CPA\0_2_CN_EN_preprocessing.sql" 1>"CPA\log\0_2_CN_EN_preprocessing.log" 2>"CPA\log\error_0_2_CN_EN_preprocessing.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaMRBI -i "CPA\1_1_ProductDef.sql" 1>"CPA\log\1_1_ProductDef.log" 2>"CPA\log\error_1_1_ProductDef.log"


osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaMRBI -i "CPA\1_2_MarketDef.sql" 1>"CPA\log\1_2_MarketDef.log" 2>"CPA\log\error_1_2_MarketDef.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaMRBI -i "CPA\2_MID.sql" 1>"CPA\log\2_MID.log" 2>"CPA\log\error_2_MID.log"
