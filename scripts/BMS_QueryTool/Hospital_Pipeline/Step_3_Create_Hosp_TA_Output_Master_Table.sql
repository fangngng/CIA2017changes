...
select 
    DataType, MktType, Mkt, MktName
    , Province_EN as Geo, '1' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, Tier
    , Class
    , 'PK' as Prod_Lvl,'N'
    , Mole_Des, Mole_Cod
    , Prod_Des, Prod_Cod
...
group by DataType, MktType, Mkt, MktName , Province_EN , Hosp_ID, Hosp_Des_EN, Tier
    , Class , Mole_Des, Mole_Cod , Prod_Des, Prod_Cod
    , Pack_Des, t1.Pack_Cod ,  Manu_Des, Manu_Cod, MNC
go
...
select 
   DataType, MktType, Mkt, MktName+ ' TOTAL' as MktName
   , Province_EN as Geo, '1' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
   Tier, 'MK' as Class, 'MK' as Prod_Lvl, 'Y' as Uniq_Prod,
   null, '000000'
   , null, '0000'
   , null, '000000'
...
select 
   DataType, MktType, Mkt, Market_Name
   ,  'CHINA' as Geo, 0 as Geo_Lvl, Grp_Lvl, '99999', null, Tier
   , Class
   , Prod_Lvl, Uniq_Prod
   , Molecule_Name, Molecule_Code
   , Product_Name, Product_Code
