...
from tblQueryToolDriverATC_Prod t1 
inner join tblMAXDataRaw t2 on t1.Pack_Cod=t2.Pack_Cod
INNER JOIN tblCityListForMAX t3 ON t2.audi_cod = t3.city_EN
group by DataType , ATC1_Cod, ATC1_Des, ATC2_Cod, ATC2_Des, ATC3_Cod, ATC3_Des, ATC4_Cod, ATC4_Des
    , t3.Province_EN  , Prod_Des, Prod_Cod , CMPS_Name, CMPS_Code
    , Pack_Des, t1.Pack_Cod , Corp_Des, Corp_Cod , Manu_Des, Manu_Cod, MNC, Gene_cod
