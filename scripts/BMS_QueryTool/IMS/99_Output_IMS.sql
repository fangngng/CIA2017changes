...
GO
SELECT * INTO tblQueryTool_IMS_ATC_List FROM BMSCNProc2.dbo.tblQueryTool_IMS_ATC_List
go
...
from BMSCNProc2.dbo.tblQueryToolDriverIMS
go
...
from BMSCNProc2.dbo.tblQueryToolDriverATC
go
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_RMB_MAT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_RMB_MAT')
drop index idx_tblOutput_IMS_ATC_RMB_MAT on tblOutput_IMS_ATC_RMB_MAT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_RMB_MAT ON [dbo].tblOutput_IMS_ATC_RMB_MAT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_RMB_MQT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_RMB_MQT')
drop index idx_tblOutput_IMS_ATC_RMB_MQT on tblOutput_IMS_ATC_RMB_MQT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_RMB_MQT ON [dbo].tblOutput_IMS_ATC_RMB_MQT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_RMB_MTH
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_RMB_MTH')
drop index idx_tblOutput_IMS_ATC_RMB_MTH on tblOutput_IMS_ATC_RMB_MTH
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_RMB_MTH ON [dbo].tblOutput_IMS_ATC_RMB_MTH 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_UNT_MAT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_UNT_MAT')
drop index idx_tblOutput_IMS_ATC_UNT_MAT on tblOutput_IMS_ATC_UNT_MAT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_UNT_MAT ON [dbo].tblOutput_IMS_ATC_UNT_MAT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_UNT_MQT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_UNT_MQT')
drop index idx_tblOutput_IMS_ATC_UNT_MQT on tblOutput_IMS_ATC_UNT_MQT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_UNT_MQT ON [dbo].tblOutput_IMS_ATC_UNT_MQT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_UNT_MTH
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_UNT_MTH')
drop index idx_tblOutput_IMS_ATC_UNT_MTH on tblOutput_IMS_ATC_UNT_MTH
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_UNT_MTH ON [dbo].tblOutput_IMS_ATC_UNT_MTH 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_USD_MAT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_USD_MAT')
drop index idx_tblOutput_IMS_ATC_USD_MAT on tblOutput_IMS_ATC_USD_MAT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_USD_MAT ON [dbo].tblOutput_IMS_ATC_USD_MAT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_USD_MQT
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_USD_MQT')
drop index idx_tblOutput_IMS_ATC_USD_MQT on tblOutput_IMS_ATC_USD_MQT
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_USD_MQT ON [dbo].tblOutput_IMS_ATC_USD_MQT 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_ATC_USD_MTH
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_ATC_USD_MTH')
drop index idx_tblOutput_IMS_ATC_USD_MTH on tblOutput_IMS_ATC_USD_MTH
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_ATC_USD_MTH ON [dbo].tblOutput_IMS_ATC_USD_MTH 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MAT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MAT_Global')
drop index idx_tblOutput_IMS_TA_RMB_MAT_Global on tblOutput_IMS_TA_RMB_MAT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MAT_Global ON [dbo].tblOutput_IMS_TA_RMB_MAT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MAT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MAT_Inline')
drop index idx_tblOutput_IMS_TA_RMB_MAT_Inline on tblOutput_IMS_TA_RMB_MAT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MAT_Inline ON [dbo].tblOutput_IMS_TA_RMB_MAT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_Master_Inline_Mkt
go
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MAT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MAT_Pipeline')
drop index idx_tblOutput_IMS_TA_RMB_MAT_Pipeline on tblOutput_IMS_TA_RMB_MAT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MAT_Pipeline ON [dbo].tblOutput_IMS_TA_RMB_MAT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MQT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MQT_Global')
drop index idx_tblOutput_IMS_TA_RMB_MQT_Global on tblOutput_IMS_TA_RMB_MQT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MQT_Global ON [dbo].tblOutput_IMS_TA_RMB_MQT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MQT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MQT_Inline')
drop index idx_tblOutput_IMS_TA_RMB_MQT_Inline on tblOutput_IMS_TA_RMB_MQT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MQT_Inline ON [dbo].tblOutput_IMS_TA_RMB_MQT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MQT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MQT_Pipeline')
drop index idx_tblOutput_IMS_TA_RMB_MQT_Pipeline on tblOutput_IMS_TA_RMB_MQT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MQT_Pipeline ON [dbo].tblOutput_IMS_TA_RMB_MQT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MTH_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MTH_Global')
drop index idx_tblOutput_IMS_TA_RMB_MTH_Global on tblOutput_IMS_TA_RMB_MTH_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MTH_Global ON [dbo].tblOutput_IMS_TA_RMB_MTH_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MTH_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MTH_Inline')
    drop index idx_tblOutput_IMS_TA_RMB_MTH_Inline on tblOutput_IMS_TA_RMB_MTH_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MTH_Inline ON [dbo].tblOutput_IMS_TA_RMB_MTH_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_MTH_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_MTH_Pipeline')
drop index idx_tblOutput_IMS_TA_RMB_MTH_Pipeline on tblOutput_IMS_TA_RMB_MTH_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_MTH_Pipeline ON [dbo].tblOutput_IMS_TA_RMB_MTH_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MAT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MAT_Global')
drop index idx_tblOutput_IMS_TA_UNT_MAT_Global on tblOutput_IMS_TA_UNT_MAT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MAT_Global ON [dbo].tblOutput_IMS_TA_UNT_MAT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MAT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MAT_Inline')
drop index idx_tblOutput_IMS_TA_UNT_MAT_Inline on tblOutput_IMS_TA_UNT_MAT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MAT_Inline ON [dbo].tblOutput_IMS_TA_UNT_MAT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MAT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MAT_Pipeline')
drop index idx_tblOutput_IMS_TA_UNT_MAT_Pipeline on tblOutput_IMS_TA_UNT_MAT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MAT_Pipeline ON [dbo].tblOutput_IMS_TA_UNT_MAT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MQT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MQT_Global')
drop index idx_tblOutput_IMS_TA_UNT_MQT_Global on tblOutput_IMS_TA_UNT_MQT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MQT_Global ON [dbo].tblOutput_IMS_TA_UNT_MQT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MQT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MQT_Inline')
drop index idx_tblOutput_IMS_TA_UNT_MQT_Inline on tblOutput_IMS_TA_UNT_MQT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MQT_Inline ON [dbo].tblOutput_IMS_TA_UNT_MQT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MQT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MQT_Pipeline')
drop index idx_tblOutput_IMS_TA_UNT_MQT_Pipeline on tblOutput_IMS_TA_UNT_MQT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MQT_Pipeline ON [dbo].tblOutput_IMS_TA_UNT_MQT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MTH_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MTH_Global')
drop index idx_tblOutput_IMS_TA_UNT_MTH_Global on tblOutput_IMS_TA_UNT_MTH_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MTH_Global ON [dbo].tblOutput_IMS_TA_UNT_MTH_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MTH_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MTH_Inline')
drop index idx_tblOutput_IMS_TA_UNT_MTH_Inline on tblOutput_IMS_TA_UNT_MTH_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MTH_Inline ON [dbo].tblOutput_IMS_TA_UNT_MTH_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_MTH_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_UNT_MTH_Pipeline')
drop index idx_tblOutput_IMS_TA_UNT_MTH_Pipeline on tblOutput_IMS_TA_UNT_MTH_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_UNT_MTH_Pipeline ON [dbo].tblOutput_IMS_TA_UNT_MTH_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MAT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MAT_Global')
drop index idx_tblOutput_IMS_TA_USD_MAT_Global on tblOutput_IMS_TA_USD_MAT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MAT_Global ON [dbo].tblOutput_IMS_TA_USD_MAT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MAT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MAT_Inline')
drop index idx_tblOutput_IMS_TA_USD_MAT_Inline on tblOutput_IMS_TA_USD_MAT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MAT_Inline ON [dbo].tblOutput_IMS_TA_USD_MAT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MAT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MAT_Pipeline')
drop index idx_tblOutput_IMS_TA_USD_MAT_Pipeline on tblOutput_IMS_TA_USD_MAT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MAT_Pipeline ON [dbo].tblOutput_IMS_TA_USD_MAT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MQT_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MQT_Global')
drop index idx_tblOutput_IMS_TA_USD_MQT_Global on tblOutput_IMS_TA_USD_MQT_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MQT_Global ON [dbo].tblOutput_IMS_TA_USD_MQT_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MQT_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MQT_Inline')
drop index idx_tblOutput_IMS_TA_USD_MQT_Inline on tblOutput_IMS_TA_USD_MQT_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MQT_Inline ON [dbo].tblOutput_IMS_TA_USD_MQT_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MQT_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MQT_Pipeline')
drop index idx_tblOutput_IMS_TA_USD_MQT_Pipeline on tblOutput_IMS_TA_USD_MQT_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MQT_Pipeline ON [dbo].tblOutput_IMS_TA_USD_MQT_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MTH_Global
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MTH_Global')
drop index idx_tblOutput_IMS_TA_USD_MTH_Global on tblOutput_IMS_TA_USD_MTH_Global
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MTH_Global ON [dbo].tblOutput_IMS_TA_USD_MTH_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MTH_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MTH_Inline')
drop index idx_tblOutput_IMS_TA_USD_MTH_Inline on tblOutput_IMS_TA_USD_MTH_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MTH_Inline ON [dbo].tblOutput_IMS_TA_USD_MTH_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_MTH_Pipeline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_USD_MTH_Pipeline')
drop index idx_tblOutput_IMS_TA_USD_MTH_Pipeline on tblOutput_IMS_TA_USD_MTH_Pipeline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_USD_MTH_Pipeline ON [dbo].tblOutput_IMS_TA_USD_MTH_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
--YTD
print '--tblOutput_IMS_TA_RMB_YTD_Inline'
if object_id(N'tblOutput_IMS_TA_RMB_YTD_Inline',N'U') is not null
	drop table tblOutput_IMS_TA_RMB_YTD_Inline
go
select * into tblOutput_IMS_TA_RMB_YTD_Inline
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_YTD_Inline
go

if exists(select * from sysindexes where name='idx_tblOutput_IMS_TA_RMB_YTD_Inline')
drop index idx_tblOutput_IMS_TA_RMB_YTD_Inline on tblOutput_IMS_TA_RMB_YTD_Inline
go
    CREATE CLUSTERED INDEX idx_tblOutput_IMS_TA_RMB_YTD_Inline ON [dbo].tblOutput_IMS_TA_RMB_YTD_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_USD_YTD_Inline'
if object_id(N'tblOutput_IMS_TA_USD_YTD_Inline',N'U') is not null
	drop table tblOutput_IMS_TA_USD_YTD_Inline
go
select * into tblOutput_IMS_TA_USD_YTD_Inline
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_YTD_Inline
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_USD_YTD_Inline')
drop index tblOutput_IMS_TA_USD_YTD_Inline on tblOutput_IMS_TA_USD_YTD_Inline
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_USD_YTD_Inline ON [dbo].tblOutput_IMS_TA_USD_YTD_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_UNT_YTD_Inline'
if object_id(N'tblOutput_IMS_TA_UNT_YTD_Inline',N'U') is not null
	drop table tblOutput_IMS_TA_UNT_YTD_Inline
go
select * into tblOutput_IMS_TA_UNT_YTD_Inline
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_YTD_Inline
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_UNT_YTD_Inline')
drop index tblOutput_IMS_TA_UNT_YTD_Inline on tblOutput_IMS_TA_UNT_YTD_Inline
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_UNT_YTD_Inline ON [dbo].tblOutput_IMS_TA_UNT_YTD_Inline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_RMB_YTD_Pipeline'
if object_id(N'tblOutput_IMS_TA_RMB_YTD_Pipeline',N'U') is not null
	drop table tblOutput_IMS_TA_RMB_YTD_Pipeline
go
select * into tblOutput_IMS_TA_RMB_YTD_Pipeline
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_YTD_Pipeline
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_RMB_YTD_Pipeline')
drop index tblOutput_IMS_TA_RMB_YTD_Pipeline on tblOutput_IMS_TA_RMB_YTD_Pipeline
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_RMB_YTD_Pipeline ON [dbo].tblOutput_IMS_TA_RMB_YTD_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_USD_YTD_Pipeline'
if object_id(N'tblOutput_IMS_TA_USD_YTD_Pipeline',N'U') is not null
	drop table tblOutput_IMS_TA_USD_YTD_Pipeline
go
select * into tblOutput_IMS_TA_USD_YTD_Pipeline
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_YTD_Pipeline
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_USD_YTD_Pipeline')
drop index tblOutput_IMS_TA_USD_YTD_Pipeline on tblOutput_IMS_TA_USD_YTD_Pipeline
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_USD_YTD_Pipeline ON [dbo].tblOutput_IMS_TA_USD_YTD_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_UNT_YTD_Pipeline'
if object_id(N'tblOutput_IMS_TA_UNT_YTD_Pipeline',N'U') is not null
	drop table tblOutput_IMS_TA_UNT_YTD_Pipeline
go
select * into tblOutput_IMS_TA_UNT_YTD_Pipeline
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_YTD_Pipeline
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_UNT_YTD_Pipeline')
drop index tblOutput_IMS_TA_UNT_YTD_Pipeline on tblOutput_IMS_TA_UNT_YTD_Pipeline
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_UNT_YTD_Pipeline ON [dbo].tblOutput_IMS_TA_UNT_YTD_Pipeline 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_RMB_YTD_Global'
if object_id(N'tblOutput_IMS_TA_RMB_YTD_Global',N'U') is not null
	drop table tblOutput_IMS_TA_RMB_YTD_Global
go
select * into tblOutput_IMS_TA_RMB_YTD_Global
from BMSCNProc2.dbo.tblOutput_IMS_TA_RMB_YTD_Global
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_RMB_YTD_Global')
drop index tblOutput_IMS_TA_RMB_YTD_Global on tblOutput_IMS_TA_RMB_YTD_Global
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_RMB_YTD_Global ON [dbo].tblOutput_IMS_TA_RMB_YTD_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_USD_YTD_Global'
if object_id(N'tblOutput_IMS_TA_USD_YTD_Global',N'U') is not null
	drop table tblOutput_IMS_TA_USD_YTD_Global
go
select * into tblOutput_IMS_TA_USD_YTD_Global
from BMSCNProc2.dbo.tblOutput_IMS_TA_USD_YTD_Global
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_USD_YTD_Global')
drop index tblOutput_IMS_TA_USD_YTD_Global on tblOutput_IMS_TA_USD_YTD_Global
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_USD_YTD_Global ON [dbo].tblOutput_IMS_TA_USD_YTD_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_TA_UNT_YTD_Global'
if object_id(N'tblOutput_IMS_TA_UNT_YTD_Global',N'U') is not null
	drop table tblOutput_IMS_TA_UNT_YTD_Global
go
select * into tblOutput_IMS_TA_UNT_YTD_Global
from BMSCNProc2.dbo.tblOutput_IMS_TA_UNT_YTD_Global
go

if exists(select * from sysindexes where name='tblOutput_IMS_TA_UNT_YTD_Global')
drop index tblOutput_IMS_TA_UNT_YTD_Global on tblOutput_IMS_TA_UNT_YTD_Global
go
    CREATE CLUSTERED INDEX tblOutput_IMS_TA_UNT_YTD_Global ON [dbo].tblOutput_IMS_TA_UNT_YTD_Global 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_ATC_RMB_YTD'
if object_id(N'tblOutput_IMS_ATC_RMB_YTD',N'U') is not null
	drop table tblOutput_IMS_ATC_RMB_YTD
go
select * into tblOutput_IMS_ATC_RMB_YTD
from BMSCNProc2.dbo.tblOutput_IMS_ATC_RMB_YTD
go

if exists(select * from sysindexes where name='tblOutput_IMS_ATC_RMB_YTD')
drop index tblOutput_IMS_ATC_RMB_YTD on tblOutput_IMS_ATC_RMB_YTD
go
    CREATE CLUSTERED INDEX tblOutput_IMS_ATC_RMB_YTD ON [dbo].tblOutput_IMS_ATC_RMB_YTD 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_ATC_USD_YTD'
if object_id(N'tblOutput_IMS_ATC_USD_YTD',N'U') is not null
	drop table tblOutput_IMS_ATC_USD_YTD
go
select * into tblOutput_IMS_ATC_USD_YTD
from BMSCNProc2.dbo.tblOutput_IMS_ATC_USD_YTD
go

if exists(select * from sysindexes where name='tblOutput_IMS_ATC_USD_YTD')
drop index tblOutput_IMS_ATC_USD_YTD on tblOutput_IMS_ATC_USD_YTD
go
    CREATE CLUSTERED INDEX tblOutput_IMS_ATC_USD_YTD ON [dbo].tblOutput_IMS_ATC_USD_YTD 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
print '--tblOutput_IMS_ATC_UNT_YTD'
if object_id(N'tblOutput_IMS_ATC_UNT_YTD',N'U') is not null
	drop table tblOutput_IMS_ATC_UNT_YTD
go
select * into tblOutput_IMS_ATC_UNT_YTD
from BMSCNProc2.dbo.tblOutput_IMS_ATC_UNT_YTD
go

if exists(select * from sysindexes where name='tblOutput_IMS_ATC_UNT_YTD')
drop index tblOutput_IMS_ATC_UNT_YTD on tblOutput_IMS_ATC_UNT_YTD
go
    CREATE CLUSTERED INDEX tblOutput_IMS_ATC_UNT_YTD ON [dbo].tblOutput_IMS_ATC_UNT_YTD 
    (
    [geo] ASC,
    [prod_lvl] ASC,
	[package_code] ASC
...
tblOutput_IMS_TA_RMB_YTD_Inline
tblOutput_IMS_TA_USD_YTD_Inline
tblOutput_IMS_TA_UNT_YTD_Inline
tblOutput_IMS_TA_RMB_YTD_Pipeline
tblOutput_IMS_TA_USD_YTD_Pipeline
tblOutput_IMS_TA_UNT_YTD_Pipeline
tblOutput_IMS_TA_RMB_YTD_Global
tblOutput_IMS_TA_USD_YTD_Global
tblOutput_IMS_TA_UNT_YTD_Global
tblOutput_IMS_ATC_RMB_YTD
tblOutput_IMS_ATC_USD_YTD
tblOutput_IMS_ATC_UNT_YTD
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MTH_Inline')
DROP VIEW tblOutput_IMS_TA_MTH_Inline
go
CREATE VIEW tblOutput_IMS_TA_MTH_Inline
as
...
from tblOutput_IMS_TA_RMB_MTH_Inline a
inner join tblOutput_IMS_TA_USD_MTH_Inline b
...
inner join tblOutput_IMS_TA_UNT_MTH_Inline c
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MTH_Pipeline')
DROP VIEW tblOutput_IMS_TA_MTH_Pipeline
go
CREATE VIEW tblOutput_IMS_TA_MTH_Pipeline
as
select 'MTH' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MTH_60,a.VR_MTH_59,a.VR_MTH_58,a.VR_MTH_57,a.VR_MTH_56,a.VR_MTH_55,a.VR_MTH_54,a.VR_MTH_53,a.VR_MTH_52,a.VR_MTH_51,a.VR_MTH_50,a.VR_MTH_49,a.VR_MTH_48,a.VR_MTH_47,a.VR_MTH_46,
...
c.UT_MTH_30,c.UT_MTH_29,c.UT_MTH_28,c.UT_MTH_27,c.UT_MTH_26,c.UT_MTH_25,c.UT_MTH_24,c.UT_MTH_23,c.UT_MTH_22,c.UT_MTH_21,c.UT_MTH_20,c.UT_MTH_19,c.UT_MTH_18,c.UT_MTH_17,c.UT_MTH_16,
c.UT_MTH_15,c.UT_MTH_14,c.UT_MTH_13,c.UT_MTH_12,c.UT_MTH_11,c.UT_MTH_10,c.UT_MTH_9,c.UT_MTH_8,c.UT_MTH_7,c.UT_MTH_6,c.UT_MTH_5,c.UT_MTH_4,c.UT_MTH_3,c.UT_MTH_2,c.UT_MTH_1
from tblOutput_IMS_TA_RMB_MTH_Pipeline a
inner join tblOutput_IMS_TA_USD_MTH_Pipeline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MTH_Pipeline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MTH_Global')
DROP VIEW tblOutput_IMS_TA_MTH_Global
go
CREATE VIEW tblOutput_IMS_TA_MTH_Global
as
select 'MTH' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MTH_60,a.VR_MTH_59,a.VR_MTH_58,a.VR_MTH_57,a.VR_MTH_56,a.VR_MTH_55,a.VR_MTH_54,a.VR_MTH_53,a.VR_MTH_52,a.VR_MTH_51,a.VR_MTH_50,a.VR_MTH_49,a.VR_MTH_48,a.VR_MTH_47,a.VR_MTH_46,
...
c.UT_MTH_30,c.UT_MTH_29,c.UT_MTH_28,c.UT_MTH_27,c.UT_MTH_26,c.UT_MTH_25,c.UT_MTH_24,c.UT_MTH_23,c.UT_MTH_22,c.UT_MTH_21,c.UT_MTH_20,c.UT_MTH_19,c.UT_MTH_18,c.UT_MTH_17,c.UT_MTH_16,
c.UT_MTH_15,c.UT_MTH_14,c.UT_MTH_13,c.UT_MTH_12,c.UT_MTH_11,c.UT_MTH_10,c.UT_MTH_9,c.UT_MTH_8,c.UT_MTH_7,c.UT_MTH_6,c.UT_MTH_5,c.UT_MTH_4,c.UT_MTH_3,c.UT_MTH_2,c.UT_MTH_1
from tblOutput_IMS_TA_RMB_MTH_Global a
inner join tblOutput_IMS_TA_USD_MTH_Global b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MTH_Global c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
go
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MQT_Inline')
DROP VIEW tblOutput_IMS_TA_MQT_Inline
go
CREATE VIEW tblOutput_IMS_TA_MQT_Inline
as
...
from tblOutput_IMS_TA_RMB_MQT_Inline a
inner join tblOutput_IMS_TA_USD_MQT_Inline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MQT_Inline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
go
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MQT_Pipeline')
DROP VIEW tblOutput_IMS_TA_MQT_Pipeline
go
CREATE VIEW tblOutput_IMS_TA_MQT_Pipeline
as
select 'MQT' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MQT_60,a.VR_MQT_59,a.VR_MQT_58,a.VR_MQT_57,a.VR_MQT_56,a.VR_MQT_55,a.VR_MQT_54,a.VR_MQT_53,a.VR_MQT_52,a.VR_MQT_51,a.VR_MQT_50,a.VR_MQT_49,a.VR_MQT_48,a.VR_MQT_47,a.VR_MQT_46,
...
c.UT_MQT_30,c.UT_MQT_29,c.UT_MQT_28,c.UT_MQT_27,c.UT_MQT_26,c.UT_MQT_25,c.UT_MQT_24,c.UT_MQT_23,c.UT_MQT_22,c.UT_MQT_21,c.UT_MQT_20,c.UT_MQT_19,c.UT_MQT_18,c.UT_MQT_17,c.UT_MQT_16,
c.UT_MQT_15,c.UT_MQT_14,c.UT_MQT_13,c.UT_MQT_12,c.UT_MQT_11,c.UT_MQT_10,c.UT_MQT_9,c.UT_MQT_8,c.UT_MQT_7,c.UT_MQT_6,c.UT_MQT_5,c.UT_MQT_4,c.UT_MQT_3,c.UT_MQT_2,c.UT_MQT_1
from tblOutput_IMS_TA_RMB_MQT_Pipeline a
inner join tblOutput_IMS_TA_USD_MQT_Pipeline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MQT_Pipeline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MQT_Global')
DROP VIEW tblOutput_IMS_TA_MQT_Global
go
CREATE VIEW tblOutput_IMS_TA_MQT_Global
as
select 'MQT' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MQT_60,a.VR_MQT_59,a.VR_MQT_58,a.VR_MQT_57,a.VR_MQT_56,a.VR_MQT_55,a.VR_MQT_54,a.VR_MQT_53,a.VR_MQT_52,a.VR_MQT_51,a.VR_MQT_50,a.VR_MQT_49,a.VR_MQT_48,a.VR_MQT_47,a.VR_MQT_46,
...
c.UT_MQT_30,c.UT_MQT_29,c.UT_MQT_28,c.UT_MQT_27,c.UT_MQT_26,c.UT_MQT_25,c.UT_MQT_24,c.UT_MQT_23,c.UT_MQT_22,c.UT_MQT_21,c.UT_MQT_20,c.UT_MQT_19,c.UT_MQT_18,c.UT_MQT_17,c.UT_MQT_16,
c.UT_MQT_15,c.UT_MQT_14,c.UT_MQT_13,c.UT_MQT_12,c.UT_MQT_11,c.UT_MQT_10,c.UT_MQT_9,c.UT_MQT_8,c.UT_MQT_7,c.UT_MQT_6,c.UT_MQT_5,c.UT_MQT_4,c.UT_MQT_3,c.UT_MQT_2,c.UT_MQT_1
from tblOutput_IMS_TA_RMB_MQT_Global a
inner join tblOutput_IMS_TA_USD_MQT_Global b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MQT_Global c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
    and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
    and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
go
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MAT_Inline')
DROP VIEW tblOutput_IMS_TA_MAT_Inline
go
CREATE VIEW tblOutput_IMS_TA_MAT_Inline
as
...
from tblOutput_IMS_TA_RMB_MAT_Inline a
inner join tblOutput_IMS_TA_USD_MAT_Inline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MAT_Inline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MAT_Pipeline')
DROP VIEW tblOutput_IMS_TA_MAT_Pipeline
go
CREATE VIEW tblOutput_IMS_TA_MAT_Pipeline
as
select 'MAT' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MAT_60,a.VR_MAT_59,a.VR_MAT_58,a.VR_MAT_57,a.VR_MAT_56,a.VR_MAT_55,a.VR_MAT_54,a.VR_MAT_53,a.VR_MAT_52,a.VR_MAT_51,a.VR_MAT_50,a.VR_MAT_49,a.VR_MAT_48,a.VR_MAT_47,a.VR_MAT_46,
...
c.UT_MAT_30,c.UT_MAT_29,c.UT_MAT_28,c.UT_MAT_27,c.UT_MAT_26,c.UT_MAT_25,c.UT_MAT_24,c.UT_MAT_23,c.UT_MAT_22,c.UT_MAT_21,c.UT_MAT_20,c.UT_MAT_19,c.UT_MAT_18,c.UT_MAT_17,c.UT_MAT_16,
c.UT_MAT_15,c.UT_MAT_14,c.UT_MAT_13,c.UT_MAT_12,c.UT_MAT_11,c.UT_MAT_10,c.UT_MAT_9,c.UT_MAT_8,c.UT_MAT_7,c.UT_MAT_6,c.UT_MAT_5,c.UT_MAT_4,c.UT_MAT_3,c.UT_MAT_2,c.UT_MAT_1
from tblOutput_IMS_TA_RMB_MAT_Pipeline a
inner join tblOutput_IMS_TA_USD_MAT_Pipeline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MAT_Pipeline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_MAT_Global')
DROP VIEW tblOutput_IMS_TA_MAT_Global
go
CREATE VIEW tblOutput_IMS_TA_MAT_Global
as
select 'MAT' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_MAT_60,a.VR_MAT_59,a.VR_MAT_58,a.VR_MAT_57,a.VR_MAT_56,a.VR_MAT_55,a.VR_MAT_54,a.VR_MAT_53,a.VR_MAT_52,a.VR_MAT_51,a.VR_MAT_50,a.VR_MAT_49,a.VR_MAT_48,a.VR_MAT_47,a.VR_MAT_46,
...
c.UT_MAT_30,c.UT_MAT_29,c.UT_MAT_28,c.UT_MAT_27,c.UT_MAT_26,c.UT_MAT_25,c.UT_MAT_24,c.UT_MAT_23,c.UT_MAT_22,c.UT_MAT_21,c.UT_MAT_20,c.UT_MAT_19,c.UT_MAT_18,c.UT_MAT_17,c.UT_MAT_16,
c.UT_MAT_15,c.UT_MAT_14,c.UT_MAT_13,c.UT_MAT_12,c.UT_MAT_11,c.UT_MAT_10,c.UT_MAT_9,c.UT_MAT_8,c.UT_MAT_7,c.UT_MAT_6,c.UT_MAT_5,c.UT_MAT_4,c.UT_MAT_3,c.UT_MAT_2,c.UT_MAT_1
from tblOutput_IMS_TA_RMB_MAT_Global a
inner join tblOutput_IMS_TA_USD_MAT_Global b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_MAT_Global c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
go
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_YTD_Inline')
DROP VIEW tblOutput_IMS_TA_YTD_Inline
go
CREATE VIEW tblOutput_IMS_TA_YTD_Inline
as
...
from tblOutput_IMS_TA_RMB_YTD_Inline a
inner join tblOutput_IMS_TA_USD_YTD_Inline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_YTD_Inline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_YTD_Pipeline')
DROP VIEW tblOutput_IMS_TA_YTD_Pipeline
go
CREATE VIEW tblOutput_IMS_TA_YTD_Pipeline
as
select 'YTD' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_YTD_60,a.VR_YTD_59,a.VR_YTD_58,a.VR_YTD_57,a.VR_YTD_56,a.VR_YTD_55,a.VR_YTD_54,a.VR_YTD_53,a.VR_YTD_52,a.VR_YTD_51,a.VR_YTD_50,a.VR_YTD_49,a.VR_YTD_48,a.VR_YTD_47,a.VR_YTD_46,
...
c.UT_YTD_30,c.UT_YTD_29,c.UT_YTD_28,c.UT_YTD_27,c.UT_YTD_26,c.UT_YTD_25,c.UT_YTD_24,c.UT_YTD_23,c.UT_YTD_22,c.UT_YTD_21,c.UT_YTD_20,c.UT_YTD_19,c.UT_YTD_18,c.UT_YTD_17,c.UT_YTD_16,
c.UT_YTD_15,c.UT_YTD_14,c.UT_YTD_13,c.UT_YTD_12,c.UT_YTD_11,c.UT_YTD_10,c.UT_YTD_9,c.UT_YTD_8,c.UT_YTD_7,c.UT_YTD_6,c.UT_YTD_5,c.UT_YTD_4,c.UT_YTD_3,c.UT_YTD_2,c.UT_YTD_1
from tblOutput_IMS_TA_RMB_YTD_Pipeline a
inner join tblOutput_IMS_TA_USD_YTD_Pipeline b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_YTD_Pipeline c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_TA_YTD_Global')
DROP VIEW tblOutput_IMS_TA_YTD_Global
go
CREATE VIEW tblOutput_IMS_TA_YTD_Global
as
select 'YTD' as datatype,a.mkttype,a.mkt,a.market_name,a.geo,a.geo_lvl,a.class,a.class_name,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
a.corp_name,a.corp_code,a.manuf_name,a.manuf_code,a.mnc,a.generic_code,
a.VR_YTD_60,a.VR_YTD_59,a.VR_YTD_58,a.VR_YTD_57,a.VR_YTD_56,a.VR_YTD_55,a.VR_YTD_54,a.VR_YTD_53,a.VR_YTD_52,a.VR_YTD_51,a.VR_YTD_50,a.VR_YTD_49,a.VR_YTD_48,a.VR_YTD_47,a.VR_YTD_46,
...
c.UT_YTD_30,c.UT_YTD_29,c.UT_YTD_28,c.UT_YTD_27,c.UT_YTD_26,c.UT_YTD_25,c.UT_YTD_24,c.UT_YTD_23,c.UT_YTD_22,c.UT_YTD_21,c.UT_YTD_20,c.UT_YTD_19,c.UT_YTD_18,c.UT_YTD_17,c.UT_YTD_16,
c.UT_YTD_15,c.UT_YTD_14,c.UT_YTD_13,c.UT_YTD_12,c.UT_YTD_11,c.UT_YTD_10,c.UT_YTD_9,c.UT_YTD_8,c.UT_YTD_7,c.UT_YTD_6,c.UT_YTD_5,c.UT_YTD_4,c.UT_YTD_3,c.UT_YTD_2,c.UT_YTD_1
from tblOutput_IMS_TA_RMB_YTD_Global a
inner join tblOutput_IMS_TA_USD_YTD_Global b
on a.mkt=b.mkt and a.geo=b.geo and a.class=b.class and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_TA_UNT_YTD_Global c
on a.mkt=c.mkt and a.geo=c.geo and a.class=c.class and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
go
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_ATC_MTH')
DROP VIEW tblOutput_IMS_ATC_MTH
go
CREATE VIEW tblOutput_IMS_ATC_MTH
as
...
c.UT_MTH_30,c.UT_MTH_29,c.UT_MTH_28,c.UT_MTH_27,c.UT_MTH_26,c.UT_MTH_25,c.UT_MTH_24,c.UT_MTH_23,c.UT_MTH_22,c.UT_MTH_21,c.UT_MTH_20,c.UT_MTH_19,c.UT_MTH_18,c.UT_MTH_17,c.UT_MTH_16,
c.UT_MTH_15,c.UT_MTH_14,c.UT_MTH_13,c.UT_MTH_12,c.UT_MTH_11,c.UT_MTH_10,c.UT_MTH_9,c.UT_MTH_8,c.UT_MTH_7,c.UT_MTH_6,c.UT_MTH_5,c.UT_MTH_4,c.UT_MTH_3,c.UT_MTH_2,c.UT_MTH_1
from tblOutput_IMS_ATC_RMB_MTH a
inner join tblOutput_IMS_ATC_USD_MTH b
...
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_ATC_UNT_MTH c
...
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_ATC_MQT')
DROP VIEW tblOutput_IMS_ATC_MQT
go
CREATE VIEW tblOutput_IMS_ATC_MQT
as
...
c.UT_MQT_30,c.UT_MQT_29,c.UT_MQT_28,c.UT_MQT_27,c.UT_MQT_26,c.UT_MQT_25,c.UT_MQT_24,c.UT_MQT_23,c.UT_MQT_22,c.UT_MQT_21,c.UT_MQT_20,c.UT_MQT_19,c.UT_MQT_18,c.UT_MQT_17,c.UT_MQT_16,
c.UT_MQT_15,c.UT_MQT_14,c.UT_MQT_13,c.UT_MQT_12,c.UT_MQT_11,c.UT_MQT_10,c.UT_MQT_9,c.UT_MQT_8,c.UT_MQT_7,c.UT_MQT_6,c.UT_MQT_5,c.UT_MQT_4,c.UT_MQT_3,c.UT_MQT_2,c.UT_MQT_1
from tblOutput_IMS_ATC_RMB_MQT a
inner join tblOutput_IMS_ATC_USD_MQT b
on a.atc1_code=b.atc1_code and  a.atc2_code=b.atc2_code and a.atc3_code=b.atc3_code and   a.atc4_code=b.atc4_code and a.geo=b.geo and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_ATC_UNT_MQT c
on a.atc1_code=c.atc1_code and  a.atc2_code=c.atc2_code and a.atc3_code=c.atc3_code and   a.atc4_code=c.atc4_code and a.geo=c.geo and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
...
--MAT:
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_ATC_MAT')
DROP VIEW tblOutput_IMS_ATC_MAT
go
CREATE VIEW tblOutput_IMS_ATC_MAT
as
...
select 'MAT' as datatype,a.atc1_code,a.atc1_des,a.atc2_code,a.atc2_des,a.atc3_code,a.atc3_des,a.atc4_code,a.atc4_des,a.geo,a.geo_lvl,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
    ...
    c.UT_MAT_30,c.UT_MAT_29,c.UT_MAT_28,c.UT_MAT_27,c.UT_MAT_26,c.UT_MAT_25,c.UT_MAT_24,c.UT_MAT_23,c.UT_MAT_22,c.UT_MAT_21,c.UT_MAT_20,c.UT_MAT_19,c.UT_MAT_18,c.UT_MAT_17,c.UT_MAT_16,
    c.UT_MAT_15,c.UT_MAT_14,c.UT_MAT_13,c.UT_MAT_12,c.UT_MAT_11,c.UT_MAT_10,c.UT_MAT_9,c.UT_MAT_8,c.UT_MAT_7,c.UT_MAT_6,c.UT_MAT_5,c.UT_MAT_4,c.UT_MAT_3,c.UT_MAT_2,c.UT_MAT_1
from tblOutput_IMS_ATC_RMB_MAT a
inner join tblOutput_IMS_ATC_USD_MAT b
    on a.atc1_code=b.atc1_code and  a.atc2_code=b.atc2_code and a.atc3_code=b.atc3_code and   a.atc4_code=b.atc4_code and a.geo=b.geo and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
        and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
        and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_ATC_UNT_MAT c
    on a.atc1_code=c.atc1_code and  a.atc2_code=c.atc2_code and a.atc3_code=c.atc3_code and   a.atc4_code=c.atc4_code and a.geo=c.geo and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
        and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
        and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
...
GO
--YTD:
IF EXISTS(SELECT 1 FROM sys.views WHERE name='tblOutput_IMS_ATC_YTD')
DROP VIEW tblOutput_IMS_ATC_YTD
go
CREATE VIEW tblOutput_IMS_ATC_YTD
as
...
select 'YTD' as datatype,a.atc1_code,a.atc1_des,a.atc2_code,a.atc2_des,a.atc3_code,a.atc3_des,a.atc4_code,a.atc4_des,a.geo,a.geo_lvl,a.prod_lvl,a.uniq_prod,a.product_name,a.product_code,a.cmps_name,a.cmps_code,a.package_name,a.package_code,
    ...
    c.UT_YTD_30,c.UT_YTD_29,c.UT_YTD_28,c.UT_YTD_27,c.UT_YTD_26,c.UT_YTD_25,c.UT_YTD_24,c.UT_YTD_23,c.UT_YTD_22,c.UT_YTD_21,c.UT_YTD_20,c.UT_YTD_19,c.UT_YTD_18,c.UT_YTD_17,c.UT_YTD_16,
    c.UT_YTD_15,c.UT_YTD_14,c.UT_YTD_13,c.UT_YTD_12,c.UT_YTD_11,c.UT_YTD_10,c.UT_YTD_9,c.UT_YTD_8,c.UT_YTD_7,c.UT_YTD_6,c.UT_YTD_5,c.UT_YTD_4,c.UT_YTD_3,c.UT_YTD_2,c.UT_YTD_1
from tblOutput_IMS_ATC_RMB_YTD a
inner join tblOutput_IMS_ATC_USD_YTD b
    on a.atc1_code=b.atc1_code and  a.atc2_code=b.atc2_code and a.atc3_code=b.atc3_code and   a.atc4_code=b.atc4_code and a.geo=b.geo and a.prod_lvl=b.prod_lvl and a.product_code=b.product_code and a.CMPS_code=b.CMPS_code and a.package_code=b.package_code 
        and case when a.corp_code is null then '' else a.corp_code end=case when b.corp_code is null then '' else b.corp_code end 
        and case when a.manuf_code is null then '' else a.manuf_code end =case when b.manuf_code is null then '' else b.manuf_code end
inner join tblOutput_IMS_ATC_UNT_YTD c
    on a.atc1_code=c.atc1_code and  a.atc2_code=c.atc2_code and a.atc3_code=c.atc3_code and   a.atc4_code=c.atc4_code and a.geo=c.geo and a.prod_lvl=c.prod_lvl and a.product_code=c.product_code and a.CMPS_code=c.CMPS_code and a.package_code=c.package_code 
        and case when a.corp_code is null then '' else a.corp_code end=case when c.corp_code is null then '' else c.corp_code end 
        and case when a.manuf_code is null then '' else a.manuf_code end =case when c.manuf_code is null then '' else c.manuf_code end
GO
exec BMSCNProc2.dbo.sp_Log_Event 'output','QT_IMS','99_Output_IMS.sql','End',null,null
