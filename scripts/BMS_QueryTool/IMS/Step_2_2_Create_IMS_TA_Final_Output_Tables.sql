...
exec dbo.sp_Log_Event 'Process','QT_IMS','Step_2_2_Create_IMS_TA_Final_Output_Tables.sql','Start',null,null



--Add Suxi
insert into tblOutput_IMS_TA_Master_Inline
select * from dbo.tblOutput_IMS_TA_Master_Inline_Suxi

insert into tblOutput_IMS_TA_Master
select * from dbo.tblOutput_IMS_TA_Master_Suxi
