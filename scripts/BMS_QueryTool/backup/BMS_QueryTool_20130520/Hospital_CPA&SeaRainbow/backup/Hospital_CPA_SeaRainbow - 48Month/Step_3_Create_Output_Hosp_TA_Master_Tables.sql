...
go
select distinct MktType, Mkt, MktName, Class, Prod_Des, Prod_Cod, Pack_Des, Pack_Cod, Manu_Des, Manu_Cod, MNC 
...
Tier, Class, Class as Class_Name, 'PK' as Prod_Lvl,'N', Mole_Des, 
...
Tier, Class, 'PD' as Prod_Lvl, Prod_Des+' TOTAL', Prod_Cod, Manu_Des, Manu_Cod, MNC, 
...
Insert into tblOutput_Hosp_TA_Master
select DataType, MktType, Mkt, MktName, City_EN as Geo, '2' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
Tier, 'NA' as Class, 'NA' as Class_Name, 'MO' as Prod_Lvl, 'N',
Mole_Des+' TOTAL', Mole_Cod, null, '000000000', null, '00000000000', null, null, null, 
sum(M48),sum(M47),sum(M46),sum(M45),sum(M44),sum(M43),sum(M42),sum(M41),sum(M40),sum(M39),sum(M38),sum(M37),
sum(M36),sum(M35),sum(M34),sum(M33),sum(M32),sum(M31),sum(M30),sum(M29),sum(M28),sum(M27),sum(M26),sum(M25),
sum(M24), sum(M23), sum(M22), sum(M21), sum(M20), sum(M19), sum(M18), sum(M17), sum(M16), sum(M15), sum(M14), sum(M13), 
sum(M12), sum(M11), sum(M10), sum(M09), sum(M08), sum(M07), sum(M06), sum(M05), sum(M04), sum(M03), sum(M02), sum(M01)
...
Insert into tblOutput_Hosp_TA_Master
select DataType, MktType, Mkt, MktName, City_EN as Geo, '2' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
Tier, Class, Class as Class_Name, 'MO' as Prod_Lvl, 'N', Mole_Des+' TOTAL', Mole_Cod, null, '000000000', null, '00000000000', null, null, null, 
sum(M48),sum(M47),sum(M46),sum(M45),sum(M44),sum(M43),sum(M42),sum(M41),sum(M40),sum(M39),sum(M38),sum(M37),
sum(M36),sum(M35),sum(M34),sum(M33),sum(M32),sum(M31),sum(M30),sum(M29),sum(M28),sum(M27),sum(M26),sum(M25),
sum(M24), sum(M23), sum(M22), sum(M21), sum(M20), sum(M19), sum(M18), sum(M17), sum(M16), sum(M15), sum(M14), sum(M13), 
sum(M12), sum(M11), sum(M10), sum(M09), sum(M08), sum(M07), sum(M06), sum(M05), sum(M04), sum(M03), sum(M02), sum(M01)
...
Insert into tblOutput_Hosp_TA_Master
select DataType, MktType, Mkt, MktName, City_EN as Geo, '2' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
Tier, Class, Class + ' TOTAL' as Class_Name, 'CS' as Prod_Lvl, 'Y' as Uniq_Prod,
...
Insert into tblOutput_Hosp_TA_Master
select DataType, MktType, Mkt, MktName+ ' TOTAL' as MktName, City_EN as Geo, '2' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
Tier, 'MK' as Class, null as Class_Name, 'MK' as Prod_Lvl, 'Y' as Uniq_Prod,
null, '000000', null, '000000000', null, '00000000000', null, null, null, 
sum(M48),sum(M47),sum(M46),sum(M45),sum(M44),sum(M43),sum(M42),sum(M41),sum(M40),sum(M39),sum(M38),sum(M37),
sum(M36),sum(M35),sum(M34),sum(M33),sum(M32),sum(M31),sum(M30),sum(M29),sum(M28),sum(M27),sum(M26),sum(M25),
sum(M24), sum(M23), sum(M22), sum(M21), sum(M20), sum(M19), sum(M18), sum(M17), sum(M16), sum(M15), sum(M14), sum(M13), 
...
/*Append ONCFCS Market Level data:

Insert into tblOutput_Hosp_TA_Master
select DataType, 'In-line Market' as MktType, 'ONCFCS' as Mkt, 'Taxol Market TOTAL' as MktName, City_EN as Geo, '2' as Geo_Lvl, 'H' as Grp_Lvl, Hosp_ID, Hosp_Des_EN, 
Tier, 'MK' as Class, null as Class_Name, 'MK' as Prod_Lvl, 'Y' as Uniq_Prod,
null, '000000', null, '000000000', null, '00000000000', null, null, null, 
sum(M24), sum(M23), sum(M22), sum(M21), sum(M20), sum(M19), sum(M18), sum(M17), sum(M16), sum(M15), sum(M14), sum(M13), 
sum(M12), sum(M11), sum(M10), sum(M09), sum(M08), sum(M07), sum(M06), sum(M05), sum(M04), sum(M03), sum(M02), sum(M01)
from tblHospitalDataCT t2 inner join tblHospitalList t3 on t2.CPA_ID=t3.Hosp_ID
where Pack_Cod='ONCFCSMKT00'
group by DataType, City_EN, Hosp_ID, Hosp_Des_EN, Tier
*/
