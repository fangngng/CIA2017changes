REM imp
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\0_1_init.sql" 1>"IMS\log\0_1_init.log" 2>"IMS\log\error_0_1_init.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaOtherDB -i "IMS\0_2_HKAPI_script.sql" 1>"IMS\log\0_2_HKAPI_script.log" 2>"IMS\log\error_0_2_HKAPI_script.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\0_3_in_IMS.sql" 1>"IMS\log\0_3_in_IMS.log" 2>"IMS\log\error_0_3_in_IMS.log"
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\0_4_Seeddata.sql" 1>"IMS\log\0_4_Seeddata.log" 2>"IMS\log\error_0_4_Seeddata.log"
...
osql -r -S 172.20.0.4 -U sa -P love2you -d BMSChinaCIA_IMS -i "IMS\3_1_1_Eliquis_NOAC.sql" 1>"IMS\log\3_1_1_Eliquis_NOAC.log" 2>"IMS\log\error_3_1_1_Eliquis_NOAC.log"
